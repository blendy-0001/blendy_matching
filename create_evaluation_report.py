...
content = """# API Documentation (Swagger UI) - Evaluation Report
...
with open('API_DOCUMENTATION_EVALUATION.md', 'w', encoding='utf-8') as f:
    f.write(content)

print("[OK] Evaluation report created: API_DOCUMENTATION_EVALUATION.md")
